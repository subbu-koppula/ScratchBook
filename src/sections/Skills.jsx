    ...
    <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
      <div className="grid gap-1 bg-[#1a1a1a]/80 backdrop-blur-md p-6 rounded-xl shadow-lg hover:shadow-[0_0_20px_rgba(147,112,219,0.5)] transition-shadow">
        ...
        <p className="text-sm text-[#b3b3b3]">
          Explore the art of creative writing through our interactive workshops
      ...
      <div className="grid gap-1 bg-[#1a1a1a]/80 backdrop-blur-md p-6 rounded-xl shadow-lg hover:shadow-[0_0_20px_rgba(147,112,219,0.5)] transition-shadow">
        ...
        <p className="text-sm text-[#b3b3b3]">
          Dive deep into specific genres and learn from industry experts through
          our specialized masterclasses.
        </p>
      </div>
      <div className="grid gap-1 bg-[#1a1a1a]/80 backdrop-blur-md p-6 rounded-xl shadow-lg hover:shadow-[0_0_20px_rgba(147,112,219,0.5)] transition-shadow">
        <svg
        ...
        <p className="text-sm text-[#b3b3b3]">
          Enhance your writing skills at your own pace with our comprehensive
          online courses.
        </p>
      </div>
    </div>
